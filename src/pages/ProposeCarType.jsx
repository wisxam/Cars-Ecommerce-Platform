...
const ProposeCarType = () => {
  ...
  useState(() => {
    ...
    const sendDataToApi = (formData) => {
        fetch("http://127.0.0.1:8000/api/sendCarType?type="+formData.type+"&seller_id="+formData.seller_id)
    ...
    return(
      <div className="form-container">
        ...
        <Box m="20px" >
        <h1 style={{ textAlign:'center' }} >Propose Brand</h1>
            <Form onSubmit={handleSubmit} className="login-form" >
              <TextField required className='textField-group' variant="filled" type="text" label="Brand" name="type" placeholder="Add Brand" /> <br/>
              <br/>
